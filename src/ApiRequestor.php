...
class ApiRequestor
{
     ...
     * @throws Exception
     */
    public static function get($url, $merchantId, $data_hash)
    {
        return self::remoteCall($url, $merchantId, $data_hash, 'GET');
    }
     ...
     * @throws Exception
     */
    public static function post($url, $merchantId, $data_hash)
    {
        return self::remoteCall($url, $merchantId, $data_hash, 'POST');
    }
     ...
     * @throws Exception
     */
    public static function patch($url, $merchantId, $data_hash)
    {
        return self::remoteCall($url, $merchantId, $data_hash, 'PATCH');
    }
     ...
     * @throws Exception
     */
    public static function remoteCall($url, $merchantId, $data_hash, $method)
    {
        $ch = curl_init();
